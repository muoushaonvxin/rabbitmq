...
class FibonacciRpcClient(object):
    def __init__(self):
        self.credentials = pika.PlainCredentials("hitrader", "hitrader123")
        self.connection = pika.BlockingConnection(pika.ConnectionParameters('10.203.106.234',5672,'/',self.credentials))
